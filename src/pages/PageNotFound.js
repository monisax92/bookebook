		...
		<main>
			<section className='flex flex-col justify-center px-2'>
				<div className='flex flex-col items-center my-4'>
					<p className='text-7xl text-gray-700 font-bold mt-10 mb-3 dark:text-white text-center'>
						404, Oops!
					</p>
					<p className='text-3xl text-gray-700 mb-10 dark:text-white text-center'>
						Page Not Found
					</p>
